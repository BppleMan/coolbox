...
use crate::panel::{CoolBoxPanel, Panel};
...
pub fn set_style(ctx: &egui::Context) {
    SET_STYLE.call_once(|| {
        ...
        fonts.font_data.insert(
            "iconfont".to_string(),
            FontData::from_static(include_bytes!("../../assets/iconfont.ttf")),
        );
        fonts.font_data.insert(
            "PingFang-SC-Regular".to_string(),
            FontData::from_static(include_bytes!("../../assets/PingFang-SC-Regular.ttf")),
        );
        fonts.font_data.insert(
